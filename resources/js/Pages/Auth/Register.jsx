...
export default function Register() {
    ...
    return (
        <GuestLayout>
            <Head title="Daftar Akun Baru - siGizi" />

            {/* Header Titles */}
            <div className="text-center mb-8">
                <h2 className="text-2xl font-extrabold text-gray-950 dark:text-white tracking-tight">Buat Akun Baru</h2>
                <p className="text-xs text-gray-400 mt-2 font-medium">Bergabung dan mulai hidup sehat</p>
            </div>
            ...
            <div className="relative flex items-center justify-center my-6 py-2">
                ...
                <span className="relative bg-white dark:bg-zinc-900 px-3 text-xs text-gray-400 dark:text-zinc-500 font-semibold tracking-wider">atau isi form</span>
            </div>
