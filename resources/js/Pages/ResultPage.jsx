    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="max-w-6xl mx-auto p-6 space-y-8">
                ...
                {/* PERBAIKAN: Struktur Grid Utama diperbaiki agar tidak tumpang tindih */}
                <div className="flex flex-col md:flex-row gap-8 items-stretch">

                    {/* SISI KIRI (Gambar & Health Insight) */}
                    <div className="w-full md:w-5/12 flex flex-col gap-6">
                        {/* Food Image Card */}
                        <div className="bg-white dark:bg-zinc-900 rounded-3xl overflow-hidden border border-gray-100 dark:border-zinc-800/80 shadow-sm relative aspect-[4/3] w-full min-h-[320px]">
                            <img
                                src={image}
                                alt={foodName}
                            ...
                            {/* Score Tag Overlay */}
                            <div className="absolute top-4 right-4 bg-[#1F7A54] text-white font-extrabold text-xs px-3.5 py-2 rounded-full shadow-md z-10">
                                Skor {score}
                            </div>
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent flex flex-col justify-end p-6">
                                ...
                                <p className="text-[11px] font-semibold text-gray-300 mt-1">1 porsi ~ 250g - ✓ AI Teridentifikasi</p>
                            </div>
                        </div>

                        {/* Health Insight (Pindah kesini agar rapi di bawah gambar) */}
                        <div className="bg-[#EFF7F4] dark:bg-emerald-950/10 p-6 rounded-3xl border border-emerald-100/50 dark:border-emerald-900/20 space-y-3 flex flex-col justify-center min-h-[140px]">
                    ...
                    <div className="w-full md:w-7/12 flex flex-col gap-6">
                        ...
                        <div className="bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-3xl border border-gray-100 dark:border-zinc-800/80 shadow-sm flex flex-col justify-between flex-1">
                            <div className="space-y-6">
                                <div>
                                    ...
                                    {/* PERBAIKAN: Ukuran kalori diperkecil sedikit agar tidak overflow di layar laptop */}
                                    <h3 className="text-5xl sm:text-6xl font-extrabold text-gray-900 dark:text-white mt-1 tracking-tight flex items-baseline">
                                        {calories} <span className="text-xl font-bold text-gray-400 dark:text-zinc-500 ml-2">kkal</span>
                                    </h3>
                            ...
                            <div className="space-y-4 mt-6">
                                {/* Balanced Badge Tag */}
                                <div className="inline-flex items-center space-x-2 px-3.5 py-2 bg-[#EFF7F4] dark:bg-emerald-950/20 text-[#1F7A54] dark:text-emerald-400 text-xs font-bold rounded-xl border border-emerald-100/50 dark:border-emerald-900/30 w-fit">
                        ...
                        <div className="bg-white dark:bg-zinc-900 p-6 rounded-3xl border border-gray-100 dark:border-zinc-800/80 shadow-sm space-y-4">
                            <div className="flex items-center space-x-2 text-orange-500">
                                ...
                                <h4 className="text-xs font-extrabold uppercase tracking-wider text-gray-900 dark:text-white">Rekomendasi</h4>
                            </div>
